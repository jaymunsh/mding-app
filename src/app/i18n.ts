...
const messages = {
  en: {
    ...
    helpBackup3: "Back up before clearing site data, reinstalling the app, or switching devices.",
    helpBackupTitle: "Backup",
    helpNote: "Images are not stored locally; keep important image files or URLs separately.",
    helpPreview1:
      "Markdown supports tables, task lists, callouts, code blocks, Mermaid, and images by URL.",
  ...
  ko: {
    ...
    helpBackup2:
      "백업은 iOS, iPadOS, macOS 또는 다른 브라우저에서 다시 가져올 수 있는 zip 파일입니다.",
    helpBackup3: "사이트 데이터를 지우거나 앱을 재설치하거나 기기를 바꾸기 전에는 백업하세요.",
    helpBackupTitle: "백업",
    helpNote: "이미지는 로컬에 저장하지 않습니다. 중요한 이미지 파일이나 URL은 따로 보관하세요.",
    helpPreview1: "Markdown은 표, 작업 목록, 콜아웃, 코드 블록, Mermaid, URL 이미지를 지원합니다.",
