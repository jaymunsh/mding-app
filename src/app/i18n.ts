...
const englishMessages = {
  ...
  helpToolbar7:
    "Settings controls theme, language, confirmed workspace clearing, and opens release history on GitHub in an external browser.",
...
const koreanMessages = {
  ...
  helpToolbar7:
    "설정에서는 테마, 언어와 확인 후 작업공간 전체 삭제를 관리하며, 업데이트 기록은 외부 브라우저의 GitHub에서 엽니다.",
