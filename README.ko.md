...
- Markdown 파일을 원래 폴더에 유지하면서 바로가기로 고정.
- 다중 선택 또는 데스크톱 드래그 앤 드롭으로 파일 이동, 삭제 후 되돌리기 지원.
- 설정에서 확인 후 로컬 작업공간 전체 삭제, 삭제 후 5초 동안 되돌리기 지원.
- Markdown 미리보기와 원문 편집 전환.
- 데스크톱과 모바일에서 Markdown·HTML 집중 읽기 지원.
